	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			for (int j = 0; j < trials; j ++)
			{
				...
				double estTime = (endTime - startTime) / 1000000000.0;    // time in s
				System.out.print(estTime + "\t");

				long startTime2 = System.nanoTime();
				Document doc2 = new EfficientDocument(text);
				doc2.getFleschScore();
				long endTime2 = System.nanoTime();
				double estTime2 = (endTime2 - startTime2) / 1000000000.0;    // time in s
